...
class ViewController: UIViewController {
	...
	private func setupRemoteSloder() {
		 var images = [String]()
		for i in 0...20 {
		images.append(contentsOf: 	[ "https://picjumbo.com/wp-content/uploads/pienza-town-in-tuscany_free_stock_photos_picjumbo_DSC04564-2210x1473.jpg",
		...
		remoteSlider.setImage(source: .remote(images, placeholder: #imageLiteral(resourceName: "placeholder")))
